...
# Load resources
# source $redsToolsPath/TCL_TK/Graphical_Elements.tcl
# source $redsToolsPath/TCL_TK/StdProc.tcl

# Mettre a jour le chemin pour les fichiers annexes /TCL_TK/*.tcl
#source /home/redsuser/csn/console/TCL_TK/Graphical_Elements.tcl
#source /home/redsuser/csn/console/TCL_TK/StdProc.tcl
source ./TCL_TK/Graphical_Elements.tcl
source ./TCL_TK/StdProc.tcl
...
proc CheckRunningMode {} {
  ...
  global strResourcePath runningMode usbInstallDir redsToolsPath consoleInfo usbMajor usbMinor
...
proc CreateMainWindow {} {
  ...
  message 	.top.main.moteurFrame.info -text "Contr\F4le des moteurs" -font fnt{3} -aspect 800 -borderwidth 1 -relief solid
  ...
  message 	.top.main.moteurFrame.encoder.ref.info -text "R\E9f\E9rence" -font fnt{3} -aspect 1000 -borderwidth 1 -relief solid
  ...
  message 	.top.main.moteurFrame.step.info -text "Moteur Pas \E0 pas" -font fnt{3} -aspect 500 -borderwidth 1 -relief solid
  ...
  # Cr\E9ation des commandes pour le moteur DC
   ...
   message 	.top.main.moteurFrame.step.delaiTxt -text "D\E9lai" -font fnt{4} -aspect 300
...
proc Bin2Int {binString} {
  ...
  set ttl "Contr\F4le des valeurs"
...
proc SetOutputs {} {
  ...
  if {$runningMode == "Simulation"} {
	...
	# concernant les LEDs
	force -freeze /Top_Sim/Val_A_LED_i [Dec2Bin $valA_LEDEntry 8]
	force -freeze /Top_Sim/Val_B_LED_i [Dec2Bin $valB_LEDEntry 8]
	force -freeze /Top_Sim/Val_C_LED_i [Dec2Bin $valC_LEDEntry 8]
  } else {
...
proc ReadInputs {} {
  ...
  if {$runningMode == "Simulation"} {
    set Hex0 [examine -unsigned /Top_Sim/Hex0_o]
    set Hex1 [examine -unsigned /Top_Sim/Hex1_o]
    # set Result_A_SUB [Bin2Dec [examine -unsigned /Top_Sim/Result_A_SUB_o]]
    # set Result_B_SUB [Bin2Dec [examine -unsigned /Top_Sim/Result_B_SUB_o]]
    # set Result_C_SUB [Bin2Dec [examine -unsigned /Top_Sim/Result_C_SUB_o]]
    # set Result_D_SUB [Bin2Dec [examine -unsigned /Top_Sim/Result_D_SUB_o]]	
	
	# set Result_A_port80 [Bin2Dec [examine -unsigned /Top_Sim/Result_A_port80_o]]
    # set Result_B_port80 [Bin2Dec [examine -unsigned /Top_Sim/Result_B_port80_o]]
    # set Result_C_port80 [Bin2Dec [examine -unsigned /Top_Sim/Result_C_port80_o]]
    # set Result_D_port80 [Bin2Dec [examine -unsigned /Top_Sim/Result_D_port80_o]]	
	# set Result_E_port80 [Bin2Dec [examine -unsigned /Top_Sim/Result_E_port80_o]]
    # set Result_F_port80 [Bin2Dec [examine -unsigned /Top_Sim/Result_F_port80_o]]
    # set Result_G_port80 [Bin2Dec [examine -unsigned /Top_Sim/Result_G_port80_o]]
    # set Result_H_port80 [Bin2Dec [examine -unsigned /Top_Sim/Result_H_port80_o]]	
	# set Result_I_port80 [Bin2Dec [examine -unsigned /Top_Sim/Result_I_port80_o]]
    # set Result_J_port80 [Bin2Dec [examine -unsigned /Top_Sim/Result_J_port80_o]]
	
    for {set i 0} {$i<8} {incr i} {
      set singleLedState($i) [examine  /Top_Sim/L$i\_o]
    }
  } else {
...
proc ConfigWaves {} {
  ...
  array set signalList {
	...
	Result_A_port80_o out
	Result_B_port80_o out
	Result_C_port80_o out
	Result_D_port80_o out
	Result_E_port80_o out
	Result_F_port80_o out
	Result_G_port80_o out
	Result_H_port80_o out
	Result_I_port80_o out
	Result_J_port80_o out
